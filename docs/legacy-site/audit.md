...
- **Conventions:** solo artists are filed "Last, First" (73 of them, like *Adams, Ryan*). Six bands are filed "Band, The". Covers carry the original artist in the title, like *99 Red Balloons (by Nina Hagen)* (53 of them). The list is sorted by artist, with 3 rows out of order.
